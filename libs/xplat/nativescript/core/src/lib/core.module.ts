...
import { fontAwesomeIcons } from '@bizappzone/xplat/nativescript/utils';

// libs
import { TranslateLoader, TranslateModule } from '@ngx-translate/core';
import { CoreModule, PlatformLanguageToken, PlatformWindowToken } from '@bizappzone/xplat/core';
import { throwIfAlreadyLoaded } from '@bizappzone/xplat/utils';
...
export class BazCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: BazCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'BazCoreModule');
  }
}
